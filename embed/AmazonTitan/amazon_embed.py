...
class TitanTextEmbeddings:
    ...
    def __init__(self, aws_access_key_id: str = AWS_ACCESS_KEY_ID, aws_secret_access_key: str = AWS_SECRET_ACCESS_KEY, profile_name: str = None,
...
#     logger.info("Starting example usage of CLIPEmbeddings")
#     try:
#         embeddings = TitanTextImageEmbeddings()
#         logger.info(f"Embedding dimension: {embeddings.dimension}")
#     except Exception as e:
